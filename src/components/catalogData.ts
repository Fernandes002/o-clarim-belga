...
export const CATALOG_DATA: SubTopic[] = [
  // === CATEGORY: ESPORTES ===
  {
    ...
    image: '/assets/images/belgium_sports_cycling_1782579417209.jpg',
  ...
  // === CATEGORY: GEOGRAFIA ===
  {
    ...
    image: '/assets/images/belgium_geography_nature_1782579373788.jpg',
  ...
  // === CATEGORY: ECONOMIA ===
  {
    ...
    image: '/assets/images/belgium_economy_brussels_1782579401054.jpg',
