        ...
        <AnimatePresence mode="wait">
          ...
          {selectedTopic ? (
            ...
            >
                ...
                <div className="relative h-44 rounded-none overflow-hidden p-4 flex flex-col justify-end border border-rule shadow-md">
                  {selectedTopic.image ? (
                    <img 
                    ...
                    <div className={`absolute inset-0 bg-gradient-to-b ${selectedTopic.gradient} z-0`}></div>
                  )}
                  <div className="absolute inset-0 bg-black/50 z-10"></div>
                  
                  <div className="relative z-20 flex items-center justify-between mb-1.5">
                  ...
                  <h1 className="font-serif text-lg font-black text-white relative z-20 uppercase tracking-tight">
                    {selectedTopic.title}
                  </h1>
                  <p className="text-[10px] font-mono text-white/80 italic relative z-20">
